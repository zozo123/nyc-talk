...
[Final deck (PDF)](slides/talk.pdf) · [LaTeX source](slides/talk.tex) · [Spoken script](TALK.md) · [Speaker notes](SPEAKER_NOTES.md) · [Stage runbook](RUNBOOK.md) · [Offline replay](demo/replay.html)

## The story

The checker reports **PASS**. The unauthenticated admin case still returns **200**, where policy requires **401**. The checker and candidate have the same bytes as before.
...
The question for the audience: **Who controls what makes the work releasable?**
...
- **1,307 spoken words.** A 14-minute delivery budget leaves one minute of margin. Rehearse aloud to verify your own pace.
...
The session brief is 15 minutes. The [official event series](https://zenity.io/resources/events/ai-agent-security-summit-2026) lists New York on October 21. Exact stage time and AV arrangements require organizer confirmation. Primary references and per-slide source links are in the dossier and speaker notes.
