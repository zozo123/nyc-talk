...
{\color{muted}\small Spoken notes generated from slides/talk.tex. Slides 1--11 are the talk. Slides 12--19 are for questions.}
\end{center}
...
\section*{10. One question for Monday}
{\sffamily\color{acid}10:00-11:15}\par
...
\section*{11. The door stayed open}
{\sffamily\color{acid}11:15-12:00}\par
...
\newpage
\section*{Questions}
\section*{12. The five policy cases}
...
\section*{13. Runner token and the dev disk}
{\sffamily\color{acid}Questions}\par
{\itshape Use only in questions.}\par
...
\section*{14. Allowed host, wrong account}
{\sffamily\color{acid}Questions}\par
{\itshape Use only in questions.}\par
...
\section*{15. An earlier promote stored a marker}
{\sffamily\color{acid}Questions}\par
{\itshape Use only in questions.}\par
...
\section*{17. Reproduce the factory}
{\sffamily\color{acid}Questions}\par
{\itshape Use only in questions.}\par
...
\section*{19. One unused approval}
{\sffamily\color{acid}Questions}\par
{\itshape Use only in questions.}\par
