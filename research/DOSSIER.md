...
Cases cited in the talk, each checked against its source on 24 September 2026 (slide 4, slide 10, slide 11 and backup slide A9):

- [Lehman et al., *The Surprising Creativity of Digital Evolution*, arXiv 1803.03453](https://arxiv.org/abs/1803.03453), 2018: the program-repair system GenProg learned to delete the file of expected outputs (`trusted-output.txt`), and with nothing to compare against, the tests passed.
...
- [Zheng et al., *SWE-Bench Pro Verified*, arXiv 2609.08149](https://arxiv.org/abs/2609.08149), September 2026: leakage channels in SWE-Bench Pro included hidden tests and fixtures on the local file system, future git history, upstream code hosts and task metadata. GLM-5.2 fell from 78.80% to 57.32% (21.48 points) after the anti-hacking safeguards; DeepSeek-V4-Pro moved 0.87 points. The fix includes: "We remove hidden evaluation files from the agent workspace." Their measurement, not ours.
- [CISA alert on tj-actions/changed-files, CVE-2025-30066](https://www.cisa.gov/news-events/alerts/2025/03/18/supply-chain-compromise-third-party-tj-actionschanged-files-cve-2025-30066-and-reviewdogaction), March 2025: a compromised GitHub Action printed secrets from the runner into workflow logs, public for public repositories.
- [Legit Security, *CamoLeak*, CVE-2025-59145](https://www.legitsecurity.com/blog/camoleak-critical-github-copilot-vulnerability-leaks-private-source-code), 2025: prompt injection made Copilot Chat encode private repository content into image requests through GitHub's own Camo proxy, which the content security policy allowed; mitigated in August 2025 by disabling image rendering in Copilot Chat.
